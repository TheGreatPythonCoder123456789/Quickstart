...
public class pedroteleop4 extends LinearOpMode {
    ...
    // State machine
    private enum AssistState { MANUAL, GO_TO_LAUNCH_POSE, WAIT_FOR_TAG, APRIL_ALIGN }
            ...
            switch (assistState) {
                ...
                case GO_TO_LAUNCH_POSE:
                    ...
                    if (!follower.isBusy()) {
                        ...
                        // Only enter April alignment if tag is visible
                        if (findApril(5) != null) {
                            resetAprilPID();
                            assistState = AssistState.APRIL_ALIGN;
                        } else {
                            telemetry.addLine("No tag — skipping April align");
                            assistState = AssistState.MANUAL;
                        }
                    }
                    break;
