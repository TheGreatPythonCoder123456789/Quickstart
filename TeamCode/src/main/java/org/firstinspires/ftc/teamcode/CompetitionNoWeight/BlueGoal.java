...
public class BlueGoal extends LinearOpMode {
    ...
    private final Pose launchingPose = new Pose(57.55, 89.84, Math.toRadians(-40));
    ...
    private void buildPaths() {
        ...
        path4A = follower.pathBuilder()
                ...
                .setLinearHeadingInterpolation(path3Pose.getHeading(), Math.toRadians(-43.2))
                .setConstraints(SUPER_SLOW_CONSTRAINTS)
                .build();
        ...
        path7A = follower.pathBuilder()
                ...
                .setLinearHeadingInterpolation(path6Pose.getHeading(), Math.toRadians(-43.2))
                .setConstraints(SUPER_SLOW_CONSTRAINTS)
                .build();
