...
@Autonomous(name = "Blue Back Curved Auto Telemetry", group = "Autonomous")
public class BlueBackcurrentCurvedTelemetry extends LinearOpMode {
    ...
    private void updateTelemetry() {
        ...
        telemetry.addData("Intake", intakeTop.getPower());
        telemetry.addData("Gate", gate.getPosition());

        telemetry.addData("Target RPM", RPMlow);
        telemetry.addData("Left Vel", shooter.getLeftShooterVelocity());
        telemetry.addData("Right Vel", shooter.getRightShooterVelocity());
