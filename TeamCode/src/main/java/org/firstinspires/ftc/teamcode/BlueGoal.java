...
//this one shoots preloaded and picks up first row of balls
...
public class BlueGoal extends OpMode {
    ...
    public void loop() {
        ...
        switch (currentState) {
            ...
            case FIRE_BALLS:
                // Shooter is already running at target RPM
                try {
                    // Ball 1
                    intakeTop.setPower(-1.0);
                    sleep(500); // intake runs 500 ms
                    intakeTop.setPower(0);
                    sleep(500); // wait 500 ms

                    // Ball 2
                    intakeTop.setPower(-1.0);
                    sleep(800); // intake runs 800 ms
                    intakeTop.setPower(0);
                    sleep(500); // wait 500 ms

                    // Ball 3
                    intakeTop.setPower(-1.0);
                    sleep(1000); // intake runs 1000 ms
                    intakeTop.setPower(0);
