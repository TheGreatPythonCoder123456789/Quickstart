...
public class PathRedSR_Test_ULTRA_NEW extends LinearOpMode {
    ...
    private final Pose launchingPose = new Pose(89.35, 92.6, Math.toRadians(-136.8)); // was (93,96)
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive() && currentState != AutoState.DONE) {
            ...
            switch (currentState) {
                ...
                case DRIVE_PATH1A:
                    if (stateJustEntered()) {
                        shooter.setTargetRPM(RPMlow);  // preload RPM
                ...
                case FIRE_BALLS1:
                    if (stateJustEntered()) {
                        ...
                        shooter.setTargetRPM(2200);  // normal RPM
                        shootAllBalls();
    ...
    private void waitForShooterReady() {
        ...
        while (opModeIsActive()) {
            ...
            double left = shooter.getLeftShooterVelocity();
            double right = shooter.getRightShooterVelocity();

            if (left > 1850 && right > 1850) break;
