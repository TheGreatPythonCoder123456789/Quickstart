...
@Autonomous(name = "Meet4RedBack", group = "Autonomous")
public class Meet4AutoRedMirrorThisOne extends LinearOpMode {
    ...
    private double RPMshot = 1985; //2025
    private double RPMlow = 1985;
