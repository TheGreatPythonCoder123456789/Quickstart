...
public class BlueGoal extends LinearOpMode {
    ...
    private final Pose preShootPose = new Pose(86.45, 77.24, Math.toRadians(-43.2));   // moved 4 down
    private final Pose midShootPose = new Pose(86.45, 86.84, Math.toRadians(-43.2));   // moved 4 down
    private final Pose launchingPose = new Pose(86.45, 89.84, Math.toRadians(-43.2));  // moved 4 down
    private final Pose launchingPosePreLoad = new Pose(86.45, 89.84, Math.toRadians(-43.2));
