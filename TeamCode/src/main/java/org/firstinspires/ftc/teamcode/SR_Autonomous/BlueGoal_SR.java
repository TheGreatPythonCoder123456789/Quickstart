...
public class BlueGoal_SR extends LinearOpMode {
    ...
    private void buildPaths() {
        ...
        // Path 1A: start → midShootPose (diagonal)
        ...
        // Path 1C: midShoot → shootPose (settle-only in state machine)
