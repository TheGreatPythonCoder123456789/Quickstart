...
@Autonomous(name = "Pedro Shoot Test", group = "Autonomous")
public class hp extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        follower.setPose(new Pose(50, 9, Math.toRadians(-50)));
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            Path1 = follower.pathBuilder()
                    .addPath(
                            new BezierCurve(
                                    new Pose(50, 9, Math.toRadians(-50)),
                                    new Pose(67, 49),
                                    new Pose(75, 7, Math.toRadians(-60))
                            )
                    )
